...
const VerificationCompleteStep: React.FC<VerificationCompleteStepProps> = ({
  onComplete,
  username,
}) => {
      ...
      <View style={styles.content}>
        ...
        >
          ...
          <Text style={styles.subtitle}>
            Congratulations <Text style={styles.username}>{username}</Text>!
            Your identity has been verified successfully.
          </Text>
          <Text style={styles.infoText}>
            You can now access virtual card features of your Speed Wallet!
          </Text>
        </Animated.View>
      </View>
