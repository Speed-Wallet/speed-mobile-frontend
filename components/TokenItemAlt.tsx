...
const TokenItemAlt: React.FC<TokenItemAltProps> = ({ token, selectedToken, onSelectToken }) => {
    const { balance, loading: isLoading, error: _error, globalError, isConnectingOrFetchingOverall, decimalsShown, name, symbol, logoURI } = useTokenBalance(token.address)
    const price = 2
